...
router.get('/:id', (req, res, next)=> {
    ...
    res.json(Object.values(product)[req.params.id]);
});
...
router.get('/instock/:qt', (req, res) => {
  ...
  router.get('/:id/:qt', (req, res, next)=> {
    res.json({
        id : req.params.id,
        qt : req.params.qt,
        unit_price : Math.floor(Object.values(product)[req.params.id].price),
        total_price : Math.floor(Object.values(product)[req.params.id].price) * req.params.qt,
    });
});
